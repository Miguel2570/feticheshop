...
// Refinements separados para o create
...
// Update schema - partial SEM refinements (ou com refinements separados)
export const updateCouponSchema = couponBaseSchema.partial().superRefine((data, ctx) => {
  // Validações condicionais apenas se os campos existirem
  if (
